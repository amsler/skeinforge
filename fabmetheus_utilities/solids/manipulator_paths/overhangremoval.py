...
def getManipulatedPath( close, loop, xmlElement ):
	...
	overhangVerticalAngle = math.radians( geomancer.getEvaluatedFloatZero( 'overhangverticalangle', xmlElement ) )
...
def processXMLElement( xmlElement, xmlProcessor ):
	...
	lineation.processXMLElementByFunction( getManipulatedPath, xmlElement, xmlProcessor )
