...
from skeinforge.skeinforge_tools.analyze_plugins.analyze_utilities import display_line
from skeinforge.skeinforge_tools.analyze_plugins.analyze_utilities import tableau
from skeinforge.skeinforge_tools.analyze_plugins.analyze_utilities import view_move
...
class SkeinviewRepository( tableau.TableauRepository ):
	...
	def __init__( self ):
		...
		settings.addListsToRepository( 'skeinforge.skeinforge_tools.analyze_plugins.skeinview.html', '', self )
