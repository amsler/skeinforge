...
class DimensionRepository:
	...
	def __init__( self ):
		...
		skeinforge_profile.addListsToCraftTypeRepository( 'skeinforge_tools.craft_plugins.dimension.html', self )
		self.fileNameInput = settings.FileNameInput().getFromFileName( skeinforge_interpret.getGNUTranslatorGcodeFileTypeTuples(), 'Open File for Dimension', self, '' )
