...
class TowerRepository:
	...
	def __init__( self ):
		...
		skeinforge_profile.addListsToCraftTypeRepository( 'skeinforge_tools.craft_plugins.tower.html', self )
		self.fileNameInput = settings.FileNameInput().getFromFileName( skeinforge_interpret.getGNUTranslatorGcodeFileTypeTuples(), 'Open File for Tower', self, '' )
